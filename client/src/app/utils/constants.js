...
export const LANDING_HEADER =
  "A repository to find and submit POC's, Articles, Code Snippets and connect with other developers for q&a";
export const CREATE_ACCOUNT = "Create Your Account";
export const HAVE_ACCOUNT = "Have an account?";
export const DO_NOT_HAVE_ACCOUNT = "Do not have an account?";
